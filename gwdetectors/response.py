"""a module housing logic for antenna responses
...
def response(long_wavelength_approximation=False, *args, **kwargs):
    if long_wavelength_approximation:
        return lwa_antenna_response(*args, **kwargs)
    else:
        return antenna_response(*args, **kwargs)
...
def lwa_antenna_response(theta, phi, psi, nx, ny):
    """
    computes the antenna patterns for detector arms oriented along nx and ny (cartesian vectors) in the long-wavelength approximation
